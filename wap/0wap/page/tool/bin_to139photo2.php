...
[head]
你正在把文件“<%=$title%>”直接发布到你的139设区相册。你需要粘贴你的相片上传页地址。<?php /*如果你第一次使用它，请先[read=,user,ssh&amp;u=<%=urlencode($_SERVER<('REQUEST_URI')>)%>]登记相册信息[/read]*/ ?>[hr]
...
$h->file('upfile',$_POST['fname'],/*file_get_contents($tp)."\r\n".*/file_get_contents($fn)/*.pack('L',$fz).$md5.'HuR1'*/,'image/x-png');
