...
?>
你正在把文件“<%=$title%>”（<%=fat32_f::echosize($fsize), $urf ? '，独享通道' : '，大文件共享通道，请抓紧时间发送，否则别人就抢先了'%>）分卷发布到你的139社区相册。你需要粘贴你的相片上传页地址。<?php /*如果你第一次使用它，请先[read=,user,ssh&amp;u=<%=urlencode($_SERVER<('REQUEST_URI')>)%>]登记相册信息[/read]*/ ?>[hr]
